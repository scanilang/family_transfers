...
psid_clean = psid_ind %>% 
  ...
  mutate(# Demographic Variables
         ...
         Head_College_Degree = case_when(Head_College_Degree == 1 ~ "College Degree",
                                         Head_Years_College == 5 ~ "No College",
                                         Head_College_Degree %in% 8:9 ~ NA),
         Head_Years_College = if_else(Head_Years_College == 9, NA, Head_Years_College),
         Head_College = case_when(Head_College_Degree == "College Degree" ~ "College Degree",
                                  Head_College_Degree != "College Degree" & Head_Years_College > 0 ~ "Some College",
                                  TRUE ~ "No College"),
